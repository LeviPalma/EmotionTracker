...
<div style = "margin-top: 150px;font-family: 'Ultra', serif; color:#232325; ">
    <h1>Sensores</h1>
    <form action="gravarS.php" method="post">
      <div class="mb-3">
        <label for="idsen" class="form-label">ID</label>
        <input readonly type="text" class="form-control" id="idsen" name="idsen" value='<?php echo "{$sensor['idsen']}"; ?>'>
      </div>
      <div class="mb-3">
